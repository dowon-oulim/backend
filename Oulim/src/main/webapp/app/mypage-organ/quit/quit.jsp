	...
	<main class="l-main">
		...
		<div class="main-container">
			...
			<div class="main-2">
				...
				<!-- 탈퇴 약관 -->
				<div class="term">
					<fieldset>Lorem ipsum dolor sit amet consectetur
						adipisicing elit. Qui magnam fugit consectetur vitae nemo
						accusamus ullam beatae in molestias, ipsam expedita, obcaecati,
						cupiditate fugiat atque adipisci eaque eius. Lorem ipsum dolor sit
						amet consectetur adipisicing elit. Qui magnam fugit consectetur
						vitae nemo accusamus ullam beatae in molestias, ipsam expedita,
						obcaecati, cupiditate fugiat atque adipisci eaque eius. Lorem
						ipsum dolor sit amet consectetur adipisicing elit. Qui magnam
						fugit consectetur vitae nemo accusamus ullam beatae in molestias,
						ipsam expedita, obcaecati, cupiditate fugiat atque adipisci eaque
						eius. Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui
						magnam fugit consectetur vitae nemo accusamus ullam beatae in
						molestias, ipsam expedita, obcaecati, cupiditate fugiat atque
						adipisci eaque eius. Lorem ipsum dolor sit amet consectetur
						adipisicing elit. Qui magnam fugit consectetur vitae nemo
						accusamus ullams beatae in molestias, ipsam expedita, obcaecati,
						cupiditate fugiat atque adipisci eaque eius.</fieldset>
				</div>
				...
				<div class="chk-box">
					<label class="c-checkbox"> <input type="checkbox">
						<span class="c-checkbox__box"></span> <span>
				...
				<form>
					...
					<div class="c-button-group">
						<button id="accept"
							class="c-button c-button--primary c-button--md">탈퇴</button>
